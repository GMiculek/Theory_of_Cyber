#FUNCTIONS WHICH PERFORM FSA OF AUTHENTICATION ATTACK
...
def Authentication_Attack_State2():
    global Final_Statement
    response1 = input("Is the attacker able to compromise the home network after compromising the home network? " + Yes_or_No + " ")

    if (response1 == "yes" or response1 == "y" or response1 == "Yes" or response1 == "YES" or response1 == "Y"):
        
       
        Final_Statement= Final_Statement + "The attacker succeeded in compromising the home network. Compromise Successful. Attack Complete. (State 2 -> Compromised Home Network (state 6) Success). "
        ...
        Final_Statement= Final_Statement + "The attacker failed in compromising the home network (State 2 -> Compromised Home Network (state 6) Fail). " 
        print("\nBreak down of path taken: \n")
...
def Authentication_Attack_State5():
    ...
    if (response1 == "yes" or response1 == "y" or response1 == "Yes" or response1 == "YES" or response1 == "Y"):
        ...
        Final_Statement= Final_Statement + "Attacker attempted to compromise the IoT device and succeeded. Compromise Successful. Attack Complete. (State 5 -> Compromised IoT Device (state 7) Success). "
        Authentication_Attack_closing() #compromise successful, move to closing function

    elif (response1 == "no" or response1 == "NO" or response1 == "n" or response1 == "No" or response1 == "N"):
        
        Final_Statement= Final_Statement + "Attacker attempted to compromise the IoT device and failed (State 5 -> Compromised IoT Device (state 7) Fail). "
        print("\nBreak down of path taken: \n")
