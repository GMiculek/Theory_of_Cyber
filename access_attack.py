...
response = input("Specify what type of attack you would like to perform. Enter '1' for Confidentiality Attack, '2' for Authentication Attack, '3' for Access Control Attack ")
